 ...
 * works — set the same path in the PWAKings Push Popup settings. Push delivery
 * does not depend on the worker's scope. The PWAKings popup SDK registers this
 * worker automatically once the visitor allows notifications.
 */
...
/**
 * Reports a 'seen' or 'clicked' event back to PWAKings. The tracking URL and
